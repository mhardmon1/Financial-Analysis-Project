...
# Configuration: Modify IBM Watsonx and Microsoft Azure Credentials accordingly
...
class AnalysisAgent(Agent):
    ...
    def _enrich(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        'DailyReturn', 'MA50', 'MA200', 'EMA50', 'RSI14', 'Vol30d'
        ]
        order = [c for c in order if c in d.columns]
        d = d[order]
    ...
    def run(self, ticker: str) -> Dict:
        ...
        prompt = (
            ...
            "linear and LSTM forecasts. Provide actionable insight for relevant stakeholders."
        )
